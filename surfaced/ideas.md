...
- organic anatomy fused with engineered polish
...
- reflective wet textures
- strong silhouette anchors
...
Use a strange biological subject, then restrain it with polished materials and tailored fashion language so the result stays elegant rather than chaotic.

### Motion toward payoff

Place the subject in motion, frame them from behind or in profile, and give them a clear destination in the distance to create narrative pull.
